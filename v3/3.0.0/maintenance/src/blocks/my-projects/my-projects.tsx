...
const MyProjects: FC<MyProjectsProps> = ({
  ...
  const imageClass = `my-projects__image${nightModeStatus ?
    ' my-projects__image_night_mode' : ''}`;
  const buttonClass = `my-projects__button${nightModeStatus ?
    ' my-projects__button_night_mode' : ''}`;
