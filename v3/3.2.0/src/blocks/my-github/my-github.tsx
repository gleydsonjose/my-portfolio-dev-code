...
const MyGitHub: FC<MyGitHubProps> = ({
  ...
  useEffect(() => {
    fetch('https://api.github.com/users/gleydsonjose')
    .then((data) => {
      data.json().then((json) => {
        setGitHubData({
    ...
    <section className="my-github">
      ...
      <div className={detailsClass}>
        ...
        <div className="my-github__repositories">
          ...
          <a className="my-github__repositories-link" href="https://github.com/gleydsonjose" target="_blank">{myGitHubData.goToRepositories}</a>
        </div>
      </div>
    </section>
  );
